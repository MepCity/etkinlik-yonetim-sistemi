...
namespace EventHub.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "E-posta doğrulama",
        ...
        private IdentityUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"'{nameof(IdentityUser)}' türünden bir örnek oluşturulamadı. " +
                    $"'{nameof(IdentityUser)}' soyut olmamalı ve parametresiz bir kurucuya sahip olmalıdır. Gerekirse /Areas/Identity/Pages/Account/Register.cshtml sayfasını özelleştirin.");
            }
        }
